...
| hindsight | AI 记忆系统 | v0.9.2 |
| ignis | 在浏览器中运行 Obsidian（无需远程桌面） | 0.8.10 |
| immich | 照片管理 | v3.0.3 |
| infinity | 本地 GPU Embeddings 推理服务 | cu124 |
| jellyfin | 媒体服务器 | 2026090709-arm64 |
| jellystat | 免费的 Jellyfin 开源统计应用（Tautulli 替代品）。 | 1.1.11 |
| linkwarden | Linkwarden 自托管书签管理器 | v2.16.2 |
| llamacpp | 高性能本地 LLM 推理引擎 | server-vulkan-v0.4.5 |
...
| scrob | 自托管媒体追踪（Jellyfin / Plex / Emby 同步） | 2.14.0 |
| searxng | 隐私搜索引擎 | 2026.9.7-3e454637f |
| silo | pgsty 维护的 S3 兼容对象存储（MinIO 活跃分支 Silo） | RELEASE.2026-08 |
| syncthing | 文件同步 | 2.1.3-ls228 |
| traefik | 反向代理 | v3.6.6 |
